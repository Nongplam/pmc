    ...
    $allowrule = explode(",",$allowruleraw["rule"]);
     ...
     ?>
            ...
            <div ng-app="showAllPurchaseOrderApp" ng-controller="showAllPurchaseOrderController" class="ng-scope">
                <div class=" container">
                    <br>
                    <h3 align="center">รายการกรอดราคาสินค้า</h3>
                    <hr>
                    <table class="table">
                        <thead>
                            <tr class="table-info">
                        ...
                        <tbody ng-init="getAllPurchaseOrder()">
                            <tr ng-repeat="PO in POs | orderBy : '-rptPO_no'" ng-show="checkStatus(PO.rptPO_status)">
                                ...
                                <td> <a ng-show="checkStatusKeyRemain(PO.rptPO_status,PO.rptRecivePO_Status)" href="receivePurchaseOrderPrice.php?po_no={{PO.rptPO_no}}&&rpo_no={{PO.rptRecivePO_No}}" target="_blank"><button class="btn btn-info mb-2 mr-2"><span class="icon ion-clipboard font-weight-bold"></span>&#160;กรอกราคาสินค้า</button></a> </td>
                            </tr>
                        </tbody>
                    </table>
